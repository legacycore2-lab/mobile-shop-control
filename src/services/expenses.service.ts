...
export const expensesService = {
  ...
  getCategories: (): Promise<ExpenseCategory[]> =>
    expensesRepository.getCategories(),

  createCategory: (name: string): Promise<ExpenseCategory> =>
    expensesRepository.createCategory(name),

  getAll: (): Promise<ExpenseView[]> =>
    expensesRepository.getAll(),

  getStats: () => expensesRepository.getStats(),

  create: (form: ExpenseFormData): Promise<ExpenseView> => {
  ...
  update: (id: string, form: Partial<ExpenseFormData>): Promise<void> => {
    ...
    return expensesRepository.update(id, payload)
  },
